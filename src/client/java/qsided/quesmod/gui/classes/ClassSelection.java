...
import qsided.quesmod.networking.SendClassSelectedPayload;
    ...
    protected void build(FlowLayout rootComponent) {
        ...
        try {
            ...
            rootComponent.child(Containers.verticalFlow(Sizing.fill(64), Sizing.fill(60))
                        //Description box
                        .child(Components.label(Text.translatable("classes.ques-mod.description"))
                        ...
                        .child(Containers.verticalFlow(Sizing.fill(33), Sizing.fill(60))
                                .child(Components.label(Text.translatable("classes.ques-mod.starting_gear"))
                        ...
                        //Skill level bonuses
                        .child(Containers.verticalFlow(Sizing.fill(33), Sizing.fill(60))
                                .child(Components.label(Text.translatable("classes.ques-mod.levels"))
                                        .positioning(Positioning.absolute(0,0)))
                                .surface(Surface.flat(Color.decode("#171717").getRGB()).and(Surface.outline(Color.decode("#121212").getRGB())))
                                .padding(Insets.of(3))
                                .id("starting_skills")
                ...
                if (getRpClassId().equals(id)) {
                    ...
                    roleplayClass.getStartingSkills().forEach(bonus -> {
                        rootComponent.childById(FlowLayout.class, "starting_skills")
                                .child(Components.label(Text.literal("+" + bonus.getLevel() + " ").append(Text.translatable("skills.ques-mod." + bonus.getSkill())))
            ...
            rootComponent.child(Components.button(Text.translatable("classes.ques-mod.select")
                    .append(" ")
