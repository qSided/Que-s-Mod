...
public class ConfigGenerator {
    ...
    public static void genReqsConfig() throws IOException {
        ...
        //items.add(new ItemWithRequirements("ques-mod:mythril_helmet", new Requirements("endurance", 30)));
        //items.add(new ItemWithRequirements("ques-mod:mythril_chestplate", new Requirements("endurance", 30)));
        //items.add(new ItemWithRequirements("ques-mod:mythril_leggings", new Requirements("endurance", 30)));
        //items.add(new ItemWithRequirements("ques-mod:mythril_boots", new Requirements("endurance", 30)));
