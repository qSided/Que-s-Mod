...
public record SendSkillsExperiencePayload(Float mining, Float enchanting, Float combat, Float woodcutting, Float endurance, Float agility, Float crafting) implements CustomPayload {
