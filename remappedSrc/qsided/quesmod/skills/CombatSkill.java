               ...
               try {
                   ...
                   if (mobs.contains(livingEntity.getType().getName().getString().toLowerCase())) {
                       livingEntity.getAttributeInstance(EntityAttributes.GENERIC_MAX_HEALTH).overwritePersistentModifier(
                               new EntityAttributeModifier(Identifier.of(QuesMod.MOD_ID, "health_scaling"), (state.skillLevels.getOrDefault("combat", 1) * 0.4), EntityAttributeModifier.Operation.ADD_VALUE));
                       ...
                       if (livingEntity.getAttributeInstance(EntityAttributes.GENERIC_ATTACK_DAMAGE) != null) {
                           livingEntity.getAttributeInstance(EntityAttributes.GENERIC_ATTACK_DAMAGE).overwritePersistentModifier(
                                   new EntityAttributeModifier(Identifier.of(QuesMod.MOD_ID, "damage_scaling"), (state.skillLevels.getOrDefault("combat", 1) * 0.6), EntityAttributeModifier.Operation.ADD_VALUE));
                       }
                   } else {
                       livingEntity.getAttributeInstance(EntityAttributes.GENERIC_MAX_HEALTH).overwritePersistentModifier(
                               new EntityAttributeModifier(Identifier.of(QuesMod.MOD_ID, "health_scaling"), (state.skillLevels.getOrDefault("combat", 1) * 1.8), EntityAttributeModifier.Operation.ADD_VALUE));
                       livingEntity.setHealth(livingEntity.getMaxHealth());
                       if (livingEntity.getAttributeInstance(EntityAttributes.GENERIC_ATTACK_DAMAGE) != null) {
                           livingEntity.getAttributeInstance(EntityAttributes.GENERIC_ATTACK_DAMAGE).overwritePersistentModifier(
                                   new EntityAttributeModifier(Identifier.of(QuesMod.MOD_ID, "damage_scaling"), (state.skillLevels.getOrDefault("combat", 1) * 1.15), EntityAttributeModifier.Operation.ADD_VALUE));
                       }
                       livingEntity.getAttributeInstance(EntityAttributes.GENERIC_ARMOR).overwritePersistentModifier(
                               new EntityAttributeModifier(Identifier.of(QuesMod.MOD_ID, "armor_scaling"), (state.skillLevels.getOrDefault("combat", 1) * 0.2), EntityAttributeModifier.Operation.ADD_VALUE));
                       livingEntity.getAttributeInstance(EntityAttributes.GENERIC_ARMOR_TOUGHNESS).overwritePersistentModifier(
                               new EntityAttributeModifier(Identifier.of(QuesMod.MOD_ID, "armor_toughness_scaling"), (state.skillLevels.getOrDefault("combat", 1) * 0.1), EntityAttributeModifier.Operation.ADD_VALUE));
                       livingEntity.getAttributeInstance(EntityAttributes.GENERIC_KNOCKBACK_RESISTANCE).overwritePersistentModifier(
                               new EntityAttributeModifier(Identifier.of(QuesMod.MOD_ID, "knockback_scaling"), (state.skillLevels.getOrDefault("combat", 1) * 0.01), EntityAttributeModifier.Operation.ADD_VALUE));
