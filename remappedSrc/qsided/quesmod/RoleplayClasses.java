    ...
    static {
        PALADIN =
                new RoleplayClass(
                        "Paladin",
                        "#1a3078",
                        "Paladins train their bodies, minds, and spirits in order to protect themselves and their party." +
                                " Simply taking hits isn't enough to protect everyone though, so Paladins are sure not to neglect their combat training.",
        ...
        FIGHTER =
                new RoleplayClass(
                        "Fighter",
                        "#8f242b",
                        "Whether it's a bar brawl or an all out war, Fighters are the most renowned in combat.",
                        List.of(new StartingEquipment(Items.LEATHER_CHESTPLATE.toString(), 1),
                                new StartingEquipment(Items.WOODEN_SWORD.toString(), 1)),
