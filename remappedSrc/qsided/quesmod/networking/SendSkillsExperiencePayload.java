...
public record SendSkillsExperiencePayload(Float mining, Float enchanting, Float combat, Float woodcutting, Float endurance, Float agility) implements CustomPayload {
